 ...
 * la commande pour tourner le robot de 90° à droite
 * 
...
public class TurnRightCommandTest 
{
	...
	{
		// mock
		CardinalPoint cardinalPoint = PowerMockito.mock(CardinalPoint.class);
		...
		// when
		when(cardinalPoint.turnLeft()).thenReturn(CardinalPoint.NORTH);
